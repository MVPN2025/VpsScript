  ...
  <div class="container">
    <div class="card">
      ...
      <div class="footer-icons">
        <span>Contact :</span>
        <a class="tg" href="https://t.me/movpn2025" target="_blank" title="Telegram">
          <img class="social-icon" src="https://raw.githubusercontent.com/JVPNSHOP/Admin-Zivpn/main/image/t.png" alt="Telegram">
        </a>
        <a class="fb" href="https://www.facebook.com/share/1ABe6DigUB/" target="_blank" title="Facebook">
          <img class="social-icon" src="https://raw.githubusercontent.com/JVPNSHOP/Admin-Zivpn/main/image/f.png" alt="Facebook">
        </a>
        <a class="ms" href="https://m.me/movpnadmin" target="_blank" title="Messenger">
